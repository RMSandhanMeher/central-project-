...
<nav id="navbar" class="navbar navbar-scrolled"> <!-- Removed navbar-transparent -->
    <div class="navbar-container">
        ...
        <ul class="nav-links">
            ...
            <li><a href="Appointment.jsf" class="nav-link">Create Plans</a></li>
            <li><a href="ShowInsurance.jsf" class="nav-link">Manage Policies</a></li>
            <li><a href="SearchProviders.jsf" class="nav-link">Complies</a></li>
