        ...
        <h:form id="form">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <h:inputText id="userName" value="#{recipient.userName}" 
                                 disabled="#{loginController.comingBack}" />
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <h:inputText id="mobile" value="#{recipient.mobile}" 
                                 maxlength="10"
            ...
            <!-- Submit Button -->
            <h:commandButton value="Register Patient" action="#{loginController.addRecipient}" 
