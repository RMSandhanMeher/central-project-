...
.pagination {
	...
	align-items: center;
	justify-content: flex-end; /* Align to the right, matching showInsuranceDetails */
	gap: 15px; /* Space between elements, matching showInsuranceDetails */
	margin: 25px 0 0 0; /* Margin, matching showInsuranceDetails */
